...
String 
firmwareInfo      = "V1.33   ",
firmwareDate      = "05/11/22",
firmwareContactR1 = "wjunio/",  
firmwareContactR2 = "doidosvaridos     ";        
...
LiquidCrystal_I2C lcd(0x27,20,4);   //SYSTEM PARAMETER  - Configure LCD RowCol Size and I2C Address
...
#define FAN             4//16       //SYSTEM PARAMETER - Fan GPIO Pin
...
#define buttonRight     5//17       //SYSTEM PARAMETER -
#define buttonBack      19          //SYSTEM PARAMETER - 
#define buttonSelect    23          //SYSTEM PARAMETER -
#define relayPIN        12          //SYSTEM PARAMETER -RELE1
#define relay1PIN       13          //SYSTEM PARAMETER -RELE2
#define relayoffPIN     14          //SYSTEM PARAMETER -BOTAO LIGA
...
//==================================================================================================//
char 
auth[] = "xxxx",   //   USER PARAMETER - Input Blynk Authentication Token (From email after registration)
ssid[] = "xxxxx",                            //   USER PARAMETER - Enter Your WiFi SSID
pass[] = "xxxxx";                          //   USER PARAMETER - Enter Your WiFi Password
...
voltageBatteryFloat     = 27.3000,     //   USER PARAMETER - Maximum Battery Charging Voltage (Output V)
voltageBatteryON        = 26.3000,     //   USER PARAMETER - Maximum Battery Charging Voltage (Output V)
...
electricalPrice         = 0.8317;      //   USER PARAMETER - Input electrical price per kWh (Dollar/kWh,Euro/kWh,Peso/kWh)
...
vInSystemMin            = 9.000;     //  CALIB PARAMETER - 
